...
object QuoteClickHelper {
    fun quoteActionButton(senderNick: String, sourceId: String = "discord"): Component {
        ...
        return Component.literal(" [q]")
            .withStyle(quoteButtonStyle(quotePrefill(cleanNick, sourceId)))
    }

    fun quotePrefill(senderNick: String, sourceId: String = "discord"): String {
        val cleanNick = senderNick.replace(":", "").trim()
